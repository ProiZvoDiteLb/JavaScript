...
const quiz = [
  ...
  {
    question: "Легче пера, но дольше двух минут его не удержишь.?",
    options: ["1. Дыхание", "2. Зрение", "3. Прием пищи"],
    correctAnswer: 1,
  },
  {
    question: "Какое животное является самым быстрым?",
    options: ["1. Лошадь", "2. Кот", "3. Обезьяна"],
    correctAnswer: 1,
  },
  {
    question: "Ты меня слышишь, но не видишь. Я не говорю, пока ты не скажешь.",
    options: ["1. Звук", "2. Видение", "3. Эхо"],
    correctAnswer: 3,
  },
];
